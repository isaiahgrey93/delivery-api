...
const VehicleSchema = {
    ...
    license_plate: Joi.object().keys({
        number: Joi.string()
            ...
            .example("7B 7J006R"),
        state: Joi.string()
            .description("Vehicle license plate state")
            .example("ID")
    }),
    insurance: Joi.any()
        .description("Image of proof of insurance")
        .example("[UUID]"),
    registration: Joi.any()
        .description("Image of proof of registration")
        .example("[UUID]"),
    images: Joi.array()
        .items(Joi.any().description("Image of the vehicle").example("[UUID]"))
        .max(4)
        .single(),
    user_id: Joi.string()
        .description("Unique id of the user who vehicle belongs")
        .example("[UUID]")
};
    ...
    validate: {
        ...
        params: {
            vehicle_id: Joi.string()
                .required()
                .description("The unique id of the vehcile to update")
        }
    },
    tags: ["api"],
    pre: VehiclePrehandlers,
...
module.exports.remove = {
    ...
    validate: {
        params: {
            vehicle_id: Joi.string()
                .required()
                .description("The unique id of the vehcile to remove")
        }
    },
    tags: ["api"],
    handler: function(request, reply) {
...
module.exports.getById = {
    ...
    validate: {
        params: {
            vehicle_id: Joi.string()
                .required()
                .description("The unique id of the vehcile to fetch")
        }
    },
    handler: function(request, reply) {
        let id = request.params.vehicle_id;
