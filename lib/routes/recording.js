...
module.exports.create = {
  ...
  handler: function(request, reply) {
    ...
    this.core.common.validate(recording);

    this.core.recording.create(recording)
...
module.exports.update = {
  ...
  handler: function(request, reply) {
    ...
    this.core.recording.update(recording)
      .then((recording) => reply(recording))
      .catch((err) => reply(err));
  }
}
...
module.exports.getById = {
  ...
  handler: function(request, reply) {
    ...
    this.core.recording.findById(id)
      .then((recording) => reply(recording))
      .catch((err) => reply(err));
  }
}
