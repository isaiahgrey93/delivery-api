...
module.exports.createAccount = {
  ...
  handler: function (request, reply) {
    ...
    this.core.model('User').findById(id)
      .then((user) => this.core.stripe[account_type].create(user))
      .then((account) => {
        let data = { id: id };
...
module.exports.updateAccount = {
  ...
  handler: function (request, reply) {
    ...
    this.core.model('User').findById(id)
      ...
      .then((user) => this.core.stripe[account_type].update(user[`${account_type}_id`], data))
      .then((user) => reply(user))
      .catch((err) => reply(err))
  }
}
...
module.exports.removeAccount = {
  ...
  handler: function (request, reply) {
    ...
    this.core.model('User').findById(id)
      .then((user) => this.utils.user.hasAccount(user, account_type))
      .then((user) => this.core.stripe[account_type].remove(user[`${account_type}_id`]))
      .then((account) => {
        let data = { id: id };
