...
module.exports.open = {
    ...
    handler: function (request, reply) {
        ...
        if (!ext_dialed) {
            ...
            outgoing.gather({
                action: `https://cze1tihk.burrow.io/api/support-call/open`
            ...
            .then((drive) => {
                ...
                if (drive_progress.indexOf(drive.status) < 0) {
                    ...
                    .say(`
                        ...
                        is no longer active.
                        `)
                        .say(`For more information regarding this drive, please call: ${process.env.TWILIO_PHONE}.`, { loop: 2 })
                        .pause(1)
                        .say('Thank you.')
                        .reject();
                    ...
                    switch (ext_dialed) {
                        case requester_ext: 
                            ...
                            break;
                        case driver_ext: 
                            toNumber = drive.driver ? drive.driver.phone : drive.requester.phone;
                            toPartyMessage = drive.driver ? 'Calling the joey driver.' : 'No driver has been assigned to this shipment. Calling the joey partner store.'
                            break;
                       default: 
                    ...
                    .dial({
                        ...
                        call.number(toNumber, {
                            statusCallback: `https://cze1tihk.burrow.io/api/support-call/${drive.id}/close`
                        })
                    })
