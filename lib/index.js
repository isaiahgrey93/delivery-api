...
module.exports.register = (server, options, next) => {
  ...
  server.route([
    ...
    //
    { path: '/api/accounts', method: 'GET', config: Routes.stripe.getAccountList },
    { path: '/api/accounts/{user_id}', method: 'GET', config: Routes.stripe.getAccount },
    { path: '/api/accounts/{user_id}', method: 'POST', config: Routes.stripe.createAccount },
    { path: '/api/accounts/{user_id}', method: 'PUT', config: Routes.stripe.updateAccount },
    { path: '/api/accounts/{user_id}', method: 'DELETE', config: Routes.stripe.removeAccount }
