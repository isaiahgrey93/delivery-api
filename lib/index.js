...
module.exports.register = (server, options, next) => {
  ...
  server.route([
    ...
    { path: '/api/users/{user_id}/password', method: 'POST', config: Routes.user.password_reset_request },
    { path: '/api/users/{user_id}/password/{token_id}', method: 'POST', config: Routes.user.reset_password },
