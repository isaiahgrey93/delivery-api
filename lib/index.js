...
module.exports.register = (server, options, next) => {
    ...
    server.route([
        ...
        { path: '/api/users/filter', method: 'POST', config: Routes.user.filterBy },
        { path: '/api/users/{user_role}s/role', method: 'GET', config: Routes.user.getByRole },
        { path: '/api/users/{user_id}', method: 'GET', config: Routes.user.getById },
        { path: '/api/users', method: 'POST', config: Routes.user.create },
        { path: '/api/users/{user_id}', method: ['PUT', 'PATCH'], config: Routes.user.update },
        ...
        { path: '/api/users/{email}/password', method: 'POST', config: Routes.user.reset_password },
        ...
        { path: '/api/vehicles/{vehicle_id}', method: ['PUT', 'PATCH'], config: Routes.vehicle.update },
        { path: '/api/vehicles/{vehicle_id}', method: 'DELETE', config: Routes.vehicle.remove },

        //
        // Category Routes
        //
        { path: '/api/categories', method: 'GET', config: Routes.category.getAll },
        { path: '/api/categories/{category_id}', method: 'GET', config: Routes.category.getById },
        { path: '/api/categories', method: 'POST', config: Routes.category.create },
        { path: '/api/categories/{category_id}', method: ['PUT', 'PATCH'], config: Routes.category.update },
        { path: '/api/categories/{category_id}', method: 'DELETE', config: Routes.category.remove },
        ...
        { path: '/api/presets/{preset_id}', method: ['PUT', 'PATCH'], config: Routes.preset.update },
        ...
        { path: '/api/drives/filter', method: 'POST', config: Routes.drive.filterBy },
        { path: '/api/drives/{user_id}/user', method: 'GET', config: Routes.drive.getByUser },
        { path: '/api/drives/{user_id}/stats', method: 'GET', config: Routes.drive.getStats },
        { path: '/api/drives/{drive_id}', method: 'GET', config: Routes.drive.getById },
        { path: '/api/drives', method: 'POST', config: Routes.drive.create },
        { path: '/api/drives/{drive_id}', method: ['PUT', 'PATCH'], config: Routes.drive.update },
        ...
        { path: '/api/drives/{drive_id}/accept', method: 'POST', config: Routes.drive.accept },
        ...
        { path: '/api/recordings/{recording_id}', method: ['PUT', 'PATCH'], config: Routes.recording.update },
        ...
        { path: '/api/accounts/{user_id}', method: ['PUT', 'PATCH'], config: Routes.stripe.update},
