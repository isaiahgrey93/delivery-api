...
module.exports.register = (server, options, next) => {
    ...
    server.route([
        ...
        { path: "/api/users", method: "GET", config: Routes.user.getAll },
        {
            ...
            method: "POST",
            config: Routes.user.filterBy
        },
        {
            path: "/api/users/{user_role}s/role",
            method: "GET",
            config: Routes.user.getByRole
        },
        {
        ...
        //
        {
            path: "/api/categories",
            method: "GET",
            config: Routes.category.getAll
        },
        {
            path: "/api/categories/{category_id}",
            method: "GET",
            config: Routes.category.getById
        },
        {
            path: "/api/categories",
            method: "POST",
            config: Routes.category.create
        },
        {
            path: "/api/categories/{category_id}",
            method: ["PUT", "PATCH"],
            config: Routes.category.update
        },
        {
            path: "/api/categories/{category_id}",
            method: "DELETE",
            config: Routes.category.remove
        },
        ...
        { path: "/api/drives", method: "GET", config: Routes.drive.getAll },
        {
            ...
            method: "POST",
            config: Routes.drive.filterBy
        },
        {
            path: "/api/drives/{user_id}/user",
            method: "GET",
            config: Routes.drive.getByUser
        },
        {
            path: "/api/drives/{user_id}/stats",
            method: "GET",
            config: Routes.drive.getStats
        },
        {
        ...
        },
        {
            ...
            method: "POST",
            config: Routes.drive.estimate
        },
        {
            path: "/api/drives/{drive_id}/accept",
            method: "POST",
            config: Routes.drive.accept
        },
        {
            path: "/api/drives/{drive_id}/charge",
            method: "POST",
            config: Routes.drive.charge
        },
        {
            path: "/api/drives/{drive_id}/process",
            method: "POST",
            config: Routes.drive.process
        },
        {
            path: "/api/drives/{drive_id}/refund",
            method: "POST",
            config: Routes.drive.refund
        },
        ...
        },
        {
            ...
            method: "POST",
            config: Routes.support.open
        },
        {
            path: "/api/support-call/{drive_id}/close",
            method: "POST",
            config: Routes.support.close
        },
        ...
        { path: "/api/accounts", method: "GET", config: Routes.stripe.getAll },
        {
            ...
            method: "GET",
            config: Routes.stripe.findById
        },
        {
            path: "/api/accounts/{user_id}",
            method: "POST",
            config: Routes.stripe.create
        },
        {
            path: "/api/accounts/{user_id}",
            method: ["PUT", "PATCH"],
            config: Routes.stripe.update
        },
        {
            path: "/api/accounts/{user_id}",
            method: "DELETE",
            config: Routes.stripe.remove
        },
        ...
        //
        {
            ...
            method: "POST",
            config: Routes.upload.create
        },
        {
            path: "/api/uploads/{path*}",
            method: "DELETE",
            config: Routes.upload.remove
        },
        {
            path: "/api/uploads/{path*}",
            method: "GET",
            config: Routes.upload.fetch
        }
    ]);
